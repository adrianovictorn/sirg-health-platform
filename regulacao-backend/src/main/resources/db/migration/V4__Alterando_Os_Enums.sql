-- Torna o drop idempotente para evitar falha quando a constraint não existe
ALTER TABLE solicitacao_especialidade
DROP CONSTRAINT IF EXISTS solicitacao_especialidade_especialidade_solicitada_check;

-- Passo 2: Adicionar a nova constraint com a lista completa de valores do seu Enum.
ALTER TABLE solicitacao_especialidade
...
CHECK (especialidade_solicitada IN (
    ...
    'PNEUMOLOGISTA',
    'HEMATOLOGISTA',
    'CONSULTA_OFTALMOLOGICA_REFRACAO',
    'DOPPLER',
    'MAMOGRAFIA',
    'HOLTER',
    'TESTE_ERGOMETRICO',
    ...
    'COLPOSCOPIA',
    'BIOPSIA_COLO_UTERINO',
    'MAMOGRAFIA_BILATERAL',
    ...
    'TESTE_ERGOMETRICO_CONVENCIONAL',
    'HOLTER_24_HORAS_3_CANAIS',
    'MAPA_24_HORAS_MONITORIZACAO_AMBULATORIAL_PRESSAO_ARTERIAL',
    'ENDOSCOPIA_DIGESTIVA_ALTA',
    'ENDOSCOPIA_DIGESTIVA_ALTA_COM_BIOPSIA',
    'COLONOSCOPIA',
    'COLONOSCOPIA_COM_BIOPSIA',
    'AUDIOMETRIA_TONAL_LIMIAR_COM_TESTES_DE_DISCRIMINACAO',
    'IMPEDANCIOMETRIA',
    'FUNDOSCOPIA_BINOCULAR_INDIRETA',
    'TONOMETRIA_APLANACAO',
    'DENSITOMETRIA_OSSEA_COLUNA_E_FEMUR',
    'ECOCARDIOGRAMA_TRANSTORACICO_MODO_M_BIDIMENSIONAL_DOPPLER',
    'ESPIROMETRIA_PROVA_VENTILATORIA_COMPLETA',
    'ELETROENCEFALOGRAMA_CONVENCIONAL',
    'TOMOGRAFIA_COMPUTADORIZADA_CRANIO',
    'TOMOGRAFIA_COMPUTADORIZADA_TORAX',
    'TOMOGRAFIA_COMPUTADORIZADA_ABDOMEN_TOTAL',
    'RESSONANCIA_MAGNETICA_CRANIO_ENCEFALO',
    'RESSONANCIA_MAGNETICA_COLUNA_CERVICAL',
    'RESSONANCIA_MAGNETICA_COLUNA_LOMBAR',
    'RESSONANCIA_MAGNETICA_JOELHO',
    'CINTILOGRAFIA_MIOCARDIO_PERFUSAO_REPOUSO_ESTRESSE',
    'CINTILOGRAFIA_TIREOIDE_CAPTACAO',
    'CINTILOGRAFIA_OSSEA',
    'ELETRONEUROMIOGRAFIA_MEMBROS_SUPERIORES',
    'ELETRONEUROMIOGRAFIA_MEMBROS_INFERIORES',
    'CATETERISMO_CARDIACO_ESQUERDO_DIAGNOSTICO',
    'AVALIACAO_URODINAMICA_COMPLETA',
