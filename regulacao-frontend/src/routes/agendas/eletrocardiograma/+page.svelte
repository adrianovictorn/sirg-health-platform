<script lang="ts">
    ...
    const especialidadesDoPainel = ['ELETROCARDIOGRAMA_ECG'];
...
<svelte:head>
    <title>Agenda de Eletrocardiograma</title>
</svelte:head>
...
<div class="flex min-h-screen bg-gray-100">
    ...
    <div class="flex-1 flex flex-col">
        <header class="bg-emerald-700 text-white shadow p-4 flex items-center justify-between">
            <h1 class="text-xl font-semibold">Agenda do Dia - Eletrocardiograma</h1>
            <UserMenu />
        </header>
