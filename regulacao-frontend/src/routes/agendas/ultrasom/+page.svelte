<script lang="ts">
    ...
    'ULTRASSONOGRAFIA_ARTICULAR','ULTRASSONOGRAFIA_OBSTETRICA',
...
<div class="flex min-h-screen bg-gray-100">
    <RoleBasedMenu activePage="/agendas/ultrasom" />
    <div class="flex-1 flex flex-col">
        <header class="bg-emerald-700 text-white shadow p-4 flex items-center justify-between">
            <h1 class="text-xl font-semibold">Agenda do Dia - Ultrassonografia</h1>
            <UserMenu />
        </header>
