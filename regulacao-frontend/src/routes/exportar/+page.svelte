  ...
  const tiposDeProcedimento = [
    ...
    },
    {
      ...
      especialidades: [
        ...
        'ULTRASSONOGRAFIA_TIREOIDE', 'ULTRASSONOGRAFIA_ARTICULAR', 'USG_DE_MAO','USG_UMBILICAL','USG_DORSAL','USG_JOELHO_ESQUERDO','USG_JOELHO_E','USG_JOELHO_D','USG_OMBRO_ESQUERDO','USG_OMBRO_DIREITO','USG_PUNHO_DIREITO','USG_PUNHO_ESQUERDO'
      ]
    },
    {
      label: 'Doppler',
